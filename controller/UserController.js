...
class UserController{
            ...
            if(!user){return res.status(404).json("User Not Found")}
                ...
                if(passwordValid){
                    ...
                    if(!user.refreshToken){
                        refreshToken = await jwtHelper.generateToken(user._id,process.env.ACCESS_REFRESHTOKEN_SECRET, process.env.ACCESS_REFRESHTOKEN_LIFE);
    ...
    async getQuanlityUsers(req, res) {
        try{
